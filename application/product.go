...
func (t *ProductService) CreateCategory(args []byte) error {
	cmd := command.CreateCategory{}
	if err := json.Unmarshal(args, &cmd); err != nil {
		return err
	}
	t.productDomain.Context = t.Context
	return t.productDomain.CreateCategory(cmd)
}

func (t *ProductService) DeleteCategory(args []byte) error {
	cmd := command.Delete{}
	if err := json.Unmarshal(args, &cmd); err != nil {
		return err
	}
...
func (t *ProductService) UpdateCategory(args []byte) error {
	cmd := command.UpdateCategory{}
	if err := json.Unmarshal(args, &cmd); err != nil {
		return err
	}
	t.productDomain.Context = t.Context
	return t.productDomain.UpdateCategory(cmd)
}

func (t *ProductService) FindCategory(args []byte) (any, error) {
	req := query.Request{}
	if err := json.Unmarshal(args, &req); err != nil {
		return nil, err
	}
