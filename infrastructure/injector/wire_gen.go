...
func BuildInjector(db *xorm.Engine) (*Injector, func(), error) {
	...
	handler := http.NewHandler(applicationBrandService, applicationBundleService, applicationNodeService, applicationOrderService, applicationProductService, applicationRoleService, applicationStructureService, systemService, applicationUserService)
